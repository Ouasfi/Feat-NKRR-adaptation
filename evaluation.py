...
def distance_p2p(points_src, normals_src, points_tgt, normals_tgt, KDTree = nKDTree):
    ...
    def _evaluate(self, pointcloud, pointcloud_tgt, normals=None, normals_tgt=None, onet_samples=None, mesh=None):
        ...
        if onet_samples is not None:
            if len(mesh.triangles) == 0:
                ...
                onet_pd_occ = check_contains_open3d(mesh, onet_samples[0])[0].astype(np.bool)
